...
export default function ImageUploadWall({max = 1, images = [], onUpload, clearAll = false}) {
    ...
    function handleUpload(file) {
        ...
        uploadTask.on('state_changed', function(snapshot){
            ...
            uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
                const url = downloadURL.toString().replace("https://firebasestorage.googleapis.com","https://ik.imagekit.io/biche");
